...
public class UnitsAPI extends HttpServlet {
	...
	{
		// TODO Auto-generated method stub
		String output = readObj.insertUnits(request.getParameter("accountNo"),  
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) 
			...
			{ 
			 ...
			 String output = readObj.updateUnit(paras.get("hidRecIDSave").toString(), 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) 
			...
			{ 
			 Map paras = getParasMap(request); 
			 String output = readObj.deleteUnit(paras.get("recordID").toString()); 
			response.getWriter().write(output); 
			}
